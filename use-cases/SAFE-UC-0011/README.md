...
| **Status** | `seed` |
| **NAICS 2022** | `Finance and Insurance (52)` |
| **Last updated** | `2026-02-17` |

## Workflow Description (Seed)

Banking assistant for account info, troubleshooting, and guided actions with strong authentication and disclosure controls.
