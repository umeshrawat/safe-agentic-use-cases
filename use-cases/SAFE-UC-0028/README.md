# Fake-account & inauthentic behavior detection assistant
...
| Field | Value |
|---|---|
| **SAFE Use Case ID** | `SAFE-UC-0028` |
| **Status** | `seed` |
| **NAICS 2022** | `Information (51)` |
| **Last updated** | `2026-02-17` |

## Workflow Description (Seed)

Identify fake accounts and coordinated inauthentic behavior using signals aggregation and analyst workflows.
